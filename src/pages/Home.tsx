...
const Home = () => {
  ...
  const categories = [
    { name: "Food & Beverage", icon: "🍔", color: "from-orange-400 to-red-500" },
    { name: "Technology", icon: "💻", color: "from-blue-400 to-indigo-500" },
    { name: "Art & Craft", icon: "🎨", color: "from-pink-400 to-rose-500" },
    { name: "Games", icon: "🎯", color: "from-purple-400 to-fuchsia-500" },
  ];
    ...
    <PageWrapper>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="flex flex-col items-center text-center max-w-5xl mx-auto">
            ...
            <motion.h1 
              ...
              className="text-6xl md:text-7xl lg:text-8xl font-heading font-extrabold text-gray-900 leading-[1.05] tracking-tight mb-8"
            >
              Where Creativity Meets <br className="hidden md:block" />
              <span className="text-transparent bg-clip-text bg-hero-gradient relative inline-block">
                Entrepreneurship
      ...
      <section className="py-32 bg-gray-50 relative overflow-hidden">
        <div className="container mx-auto px-4 md:px-8 max-w-7xl relative z-10">
          <div className="text-center max-w-3xl mx-auto mb-20">
            <h2 className="text-4xl md:text-6xl font-heading font-bold text-gray-900 mb-6 tracking-tight">More than just an event.</h2>
        ...
        <div className="container mx-auto px-4 md:px-8">
          <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
            <div className="max-w-2xl">
              <h2 className="text-4xl md:text-5xl font-heading font-bold text-gray-900 mb-6">Endless Possibilities</h2>
              <p className="text-xl text-gray-600 font-light">From culinary delights to tech innovations, explore diverse categories crafted by student entrepreneurs.</p>
            </div>
            <Link to="/stalls" className="btn-outline">
              View All Categories
            </Link>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {categories.map((cat, idx) => (
              ...
              >
                <div className="glass-card aspect-[4/5] relative overflow-hidden p-8 flex flex-col justify-end">
                  ...
                  <div className="absolute top-8 right-8 text-6xl group-hover:scale-125 transition-transform duration-500 origin-bottom-right">
                    {cat.icon}
                  </div>
                  <h3 className="text-2xl font-bold font-heading text-gray-900 group-hover:text-primary transition-colors">{cat.name}</h3>
                </div>
              </motion.div>
            ))}
          </div>
      ...
      <section className="py-32 bg-[#0A0F1C] text-white relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10 text-center">
          ...
          <h2 className="text-4xl md:text-6xl font-heading font-bold mb-16 tracking-tight">The countdown begins.</h2>
